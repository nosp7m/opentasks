...
package app.tasksandlists.notification;
...
import app.tasksandlists.pal.readdata.EffectiveTaskColor;
...
import app.tasksandlists.pal.readdata.TaskTitle;
import app.tasksandlists.pal.readdata.TaskVersion;
import app.tasksandlists.pal.views.InstancesView;
import org.dmfs.rfc5545.DateTime;
import org.dmfs.rfc5545.Duration;
import app.tasksandlists.JobIds;
import app.tasksandlists.actions.CancelDelayedAction;
import app.tasksandlists.actions.CancelNotificationAction;
import app.tasksandlists.actions.CompleteAction;
import app.tasksandlists.actions.Composite;
import app.tasksandlists.actions.Conditional;
import app.tasksandlists.actions.DeferDueAction;
import app.tasksandlists.actions.DelayedAction;
import app.tasksandlists.actions.NotifyStickyAction;
import app.tasksandlists.actions.OpenAction;
import app.tasksandlists.actions.PinAction;
import app.tasksandlists.actions.PostUndoAction;
import app.tasksandlists.actions.RemoveNotificationAction;
import app.tasksandlists.actions.TaskAction;
import app.tasksandlists.actions.UpdateWidgetsAction;
import app.tasksandlists.actions.WipeNotificationAction;
...
{
    public static final String CHANNEL_PINNED = "app.tasksandlists.PINNED";
    public static final String CHANNEL_DUE_DATES = "app.tasksandlists.DUE_DATES";

    public static final String ACTION_PIN_TASK = "app.tasksandlists.intent.ACTION_PIN_TASK";
    public static final String ACTION_COMPLETE = "app.tasksandlists.intent.COMPLETE";
    public static final String ACTION_UNPIN = "app.tasksandlists.intent.UNPIN";
    public static final String ACTION_OPEN_TASK = "app.tasksandlists.intent.OPEN_TASK";
    public static final String ACTION_OPEN_TASK_CANCEL_NOTIFICATION = "app.tasksandlists.intent.OPEN_CANCEL_TASK";
    public static final String ACTION_REMOVE_NOTIFICATION = "app.tasksandlists.intent.CANCEL_NOTIFICATION";
    public static final String ACTION_NEXT_DAY = "app.tasksandlists.intent.ACTION_DAY_CHANGED";
    public static final String ACTION_RENOTIFY = "app.tasksandlists.intent.NOTIFY";
    public static final String ACTION_DEFER_1D = "app.tasksandlists.action.notification.DELAY_1D";
    public static final String ACTION_UNDO_COMPLETE = "app.tasksandlists.action.notification.UNDO_COMPLETE";
    public static final String ACTION_FINISH_COMPLETE = "app.tasksandlists.action.notification.FINISH_COMPLETE";
