...
import app.tasksandlists.actions.utils.NotificationPrefs;
import app.tasksandlists.contract.TaskContract;
import app.tasksandlists.contract.TaskContract.Tasks;
import app.tasksandlists.notification.state.PrefState;
import app.tasksandlists.notification.state.RowState;
import app.tasksandlists.notification.state.StateInfo;
import app.tasksandlists.notification.state.TaskNotificationState;
    ...
    protected void onHandleWork(@NonNull Intent intent)
    {
        switch (intent.getAction())
        {
            ...
            default:
                ...
                Iterable<TaskNotificationState> currentNotifications = new app.tasksandlists.utils.Sorted<>(
