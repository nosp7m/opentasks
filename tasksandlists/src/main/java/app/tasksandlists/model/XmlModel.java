...
import app.tasksandlists.model.constraints.UpdateAllDay;
import app.tasksandlists.model.layout.LayoutDescriptor;
...
public class XmlModel extends Model
{
    ...
    public final static String METADATA_TASKS = "app.tasksandlists.TASKS";

    public final static String NAMESPACE = "app.tasksandlists";
