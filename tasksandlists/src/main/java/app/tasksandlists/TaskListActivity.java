...
import app.tasksandlists.groupings.AbstractGroupingFactory;
import app.tasksandlists.groupings.ByDueDate;
import app.tasksandlists.groupings.ByList;
import app.tasksandlists.groupings.ByPriority;
import app.tasksandlists.groupings.ByProgress;
import app.tasksandlists.groupings.BySearch;
import app.tasksandlists.groupings.ByStartDate;
import app.tasksandlists.model.ContentSet;
import app.tasksandlists.utils.BaseActivity;
import app.tasksandlists.utils.ExpandableGroupDescriptor;
import app.tasksandlists.utils.SearchHistoryHelper;
...
public class TaskListActivity extends BaseActivity implements TaskListFragment.Callbacks, ViewTaskFragment.Callback
{
     ...
     **/
    public static final String EXTRA_DISPLAY_TASK = "app.tasksandlists.DISPLAY_TASK";

    /**
     * Tells the activity to select the task in the list with the URI from the intent data.
     **/
    public static final String EXTRA_FORCE_LIST_SELECTION = "app.tasksandlists.FORCE_LIST_SELECTION";
