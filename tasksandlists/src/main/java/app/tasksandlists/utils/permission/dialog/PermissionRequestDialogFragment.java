...
package app.tasksandlists.utils.permission.dialog;
...
import app.tasksandlists.utils.ManifestAppName;
import app.tasksandlists.utils.permission.BasicAppPermissions;
import app.tasksandlists.utils.permission.utils.AppSettingsIntent;
...
public final class PermissionRequestDialogFragment extends DialogFragment
{
    ...
    private static final String KEY_IS_NORMALLY_REQUESTABLE = "app.tasksandlists.permission.isRequestable";
