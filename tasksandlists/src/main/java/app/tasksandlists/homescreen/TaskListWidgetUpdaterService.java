...
package app.tasksandlists.homescreen;
...
import app.tasksandlists.utils.TimeChangeListener;
import app.tasksandlists.utils.TimeChangeObserver;
import app.tasksandlists.utils.WidgetConfigurationDatabaseHelper;
...
public class TaskListWidgetUpdaterService extends RemoteViewsService
{
    ...
    public static class TaskListViewsFactory implements RemoteViewsService.RemoteViewsFactory, TimeChangeListener
    {
        ...
        /*
         * @see app.tasksandlists.utils.TimeChangeListener#onTimeUpdate(app.tasksandlists.utils.TimeChangeObserver)
         */
        @Override
         ...
         *
         * @see app.tasksandlists.utils.TimeChangeListener#onAlarm(app.tasksandlists.utils.TimeChangeObserver)
         */
        @Override
