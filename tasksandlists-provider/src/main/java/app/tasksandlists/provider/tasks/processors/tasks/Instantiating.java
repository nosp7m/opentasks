...
package app.tasksandlists.provider.processors.tasks;
...
import app.tasksandlists.provider.TaskDatabaseHelper;
...
import app.tasksandlists.provider.utils.InstanceValuesIterable;
import app.tasksandlists.provider.utils.Limited;
import app.tasksandlists.provider.utils.OverrideValuesFunction;
import app.tasksandlists.provider.utils.Range;
import app.tasksandlists.provider.utils.RowIterator;
import app.tasksandlists.contract.TaskContract;

import java.util.Locale;

import static app.tasksandlists.provider.model.TaskAdapter.IS_CLOSED;
