...
package app.tasksandlists.provider.model;

import android.content.ContentValues;
import android.database.Cursor;

import app.tasksandlists.provider.model.adapters.BinaryFieldAdapter;
import app.tasksandlists.provider.model.adapters.BooleanFieldAdapter;
import app.tasksandlists.provider.model.adapters.DateTimeFieldAdapter;
import app.tasksandlists.provider.model.adapters.DateTimeIterableFieldAdapter;
import app.tasksandlists.provider.model.adapters.DurationFieldAdapter;
import app.tasksandlists.provider.model.adapters.IntegerFieldAdapter;
import app.tasksandlists.provider.model.adapters.LongFieldAdapter;
import app.tasksandlists.provider.model.adapters.RRuleFieldAdapter;
import app.tasksandlists.provider.model.adapters.StringFieldAdapter;
import app.tasksandlists.provider.model.adapters.UrlFieldAdapter;
