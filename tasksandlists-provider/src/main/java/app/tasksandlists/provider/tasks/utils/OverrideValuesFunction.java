...
package app.tasksandlists.provider.utils;
...
import app.tasksandlists.provider.processors.tasks.instancedata.Distant;
import app.tasksandlists.provider.processors.tasks.instancedata.DueDated;
import app.tasksandlists.provider.processors.tasks.instancedata.Enduring;
import app.tasksandlists.provider.processors.tasks.instancedata.Overridden;
import app.tasksandlists.provider.processors.tasks.instancedata.StartDated;
import app.tasksandlists.provider.processors.tasks.instancedata.TaskRelated;
import app.tasksandlists.provider.processors.tasks.instancedata.VanillaInstanceData;
...
public final class OverrideValuesFunction implements Function<TaskAdapter, Single<ContentValues>>
{
    ...
    public Single<ContentValues> value(TaskAdapter taskAdapter)
    {
        ...
        return new app.tasksandlists.provider.utils.Zipped<>(
