...
package app.tasksandlists.provider;
...
import app.tasksandlists.provider.TaskDatabaseHelper.OnDatabaseOperationListener;
import app.tasksandlists.provider.TaskDatabaseHelper.Tables;
import app.tasksandlists.provider.handler.PropertyHandler;
import app.tasksandlists.provider.handler.PropertyHandlerFactory;
import app.tasksandlists.provider.model.ContentValuesListAdapter;
import app.tasksandlists.provider.model.ContentValuesTaskAdapter;
import app.tasksandlists.provider.model.CursorContentValuesInstanceAdapter;
import app.tasksandlists.provider.model.CursorContentValuesListAdapter;
import app.tasksandlists.provider.model.CursorContentValuesTaskAdapter;
import app.tasksandlists.provider.model.InstanceAdapter;
import app.tasksandlists.provider.model.ListAdapter;
import app.tasksandlists.provider.model.TaskAdapter;
import app.tasksandlists.provider.processors.EntityProcessor;
import app.tasksandlists.provider.processors.instances.Detaching;
import app.tasksandlists.provider.processors.instances.TaskValueDelegate;
import app.tasksandlists.provider.processors.lists.ListCommitProcessor;
import app.tasksandlists.provider.processors.tasks.AutoCompleting;
import app.tasksandlists.provider.processors.tasks.Instantiating;
import app.tasksandlists.provider.processors.tasks.Moving;
import app.tasksandlists.provider.processors.tasks.Originating;
import app.tasksandlists.provider.processors.tasks.Relating;
import app.tasksandlists.provider.processors.tasks.Reparenting;
import app.tasksandlists.provider.processors.tasks.Searchable;
import app.tasksandlists.provider.processors.tasks.TaskCommitProcessor;
import app.tasksandlists.provider.processors.tasks.Validating;
import app.tasksandlists.contract.TaskContract;
import app.tasksandlists.contract.TaskContract.Alarms;
import app.tasksandlists.contract.TaskContract.Categories;
import app.tasksandlists.contract.TaskContract.CategoriesColumns;
import app.tasksandlists.contract.TaskContract.Instances;
import app.tasksandlists.contract.TaskContract.Properties;
import app.tasksandlists.contract.TaskContract.PropertyColumns;
import app.tasksandlists.contract.TaskContract.SyncState;
import app.tasksandlists.contract.TaskContract.TaskColumns;
import app.tasksandlists.contract.TaskContract.TaskListColumns;
import app.tasksandlists.contract.TaskContract.TaskListSyncColumns;
...
public final class TaskProvider extends SQLiteContentProvider implements OnAccountsUpdateListener, OnDatabaseOperationListener
{
    ...
    public boolean onCreate()
    {
        ...
        mListProcessorChain = new app.tasksandlists.provider.processors.lists.Validating(new ListCommitProcessor());

        mInstanceProcessorChain = new app.tasksandlists.provider.processors.instances.Validating(
