...
public enum ContentOperation
{
    ...
    private static final String PREFS_NAME = "app.tasksandlists.provider";
    private static final String PREFS_KEY_LAST_ALARM_TIMESTAMP = "app.tasksandlists.provider.prefs.LAST_ALARM_TIMESTAMP";
