...
public class XmlLoader
{
	...
	public static NotificationCompat.Builder loadNotificationBuilder(Context context, int id, ITokenResolver... resolvers) throws IOException,
		XmlPullParserException, XmlObjectPullParserException
	{
		return getParser(context, id, resolvers).pull(Model.NOTIFICATION_BUILDER, null, EMPTY_PATH);
	}
