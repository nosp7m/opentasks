...
import org.dmfs.android.xmlmagic.builder.NotificationBuilderObjectBuilder;
...
public class Model
{
	...
	public final static ElementDescriptor<NotificationCompat.Builder> NOTIFICATION_BUILDER = ElementDescriptor.register(
		QualifiedName.get(NAMESPACE, "notification-builder"), NotificationBuilderObjectBuilder.INSTANCE);
