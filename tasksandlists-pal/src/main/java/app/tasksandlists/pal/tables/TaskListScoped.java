...
package app.tasksandlists.pal.tables;
...
import app.tasksandlists.pal.operations.TaskListTask;
import app.tasksandlists.pal.predicates.TaskOnList;
...
public final class TaskListScoped implements Table<TaskContract.Tasks>
{
    ...
    {
        return new app.tasksandlists.pal.views.TaskListScoped(mTaskListRow, mDelegate.view(client));
    }
